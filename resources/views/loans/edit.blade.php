                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default">
                    ...
                    <form enctype="multipart/form-data" action="/loans/{{ $loan->id }}" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Return_date <span class="text-meta-1">*</span> </label>
                                <input
                                    id="return_date"
                                    name="return_date"
                            ...
                            <div class="mb-4.5">
                            <label class="mb-3 block text-sm font-medium text-black"> Total_cost <span class="text-meta-1">*</span> </label>
                                <input
                                    id="total_cost"
                                    name="total_cost"
