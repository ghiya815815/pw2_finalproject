    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        @if (session('success'))
            <div class="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] my-4 px-7 py-6 shadow-md">
                ...
                <div class="w-full">
                    <h5 class="text-lg font-bold text-black">{{ session('success') }}</h5>
                </div>
            </div>
        @endif
        ...
        <div class="flex flex-col gap-10">
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default">
                <div class="grid grid-cols-12 border-t border-stroke px-4 py-4.5 sm:grid-cols-12 md:px-6 2xl:px-7.5">
                    ...
                    <div class="col-span-2 flex items-center">
                        <p class="font-medium">Cost/day</p>
                    </div>
                    <div class="col-span-1 flex items-center">
                    ...
                    <div class="grid grid-cols-12 border-t border-stroke px-4 py-4.5 sm:grid-cols-12 md:px-6 2xl:px-7.5">
                        ...
                        <div class="col-span-1 flex items-center">
                            <div class="w-12 rounded-md">
                                <img src="src/images/cars/{{$car->photo}}"/>
                            </div>
                        </div>
                        <div class="col-span-2 flex items-center">
                            <p class="text-sm font-medium text-black">
