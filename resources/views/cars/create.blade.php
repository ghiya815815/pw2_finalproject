            ...
            <div class="flex flex-col">
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default">
                    ...
                    <form enctype="multipart/form-data" action="/cars" method="POST">
                        ...
                        <div class="p-6.5">
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Name <span
                                        class="text-meta-1">*</span> </label>
                                <input id="name" name="name" type="text" placeholder="Enter car name"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Type <span
                                        class="text-meta-1">*</span> </label>
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                    <select id="type_id" name="type_id"
                                        ...
                                        :class="isOptionSelected && 'text-black'" @change="isOptionSelected = true">
                            ...
                            <div class="mb-4.5">
                                ...
                                <input id="photo" name="photo" type="file" placeholder="Upload car photo"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter" />
                            </div>

                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Cost per Day <span
                                        class="text-meta-1">*</span> </label>
                                <input id="cost_per_day" name="cost_per_day" type="number"
                                    placeholder="Enter cost per day"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter" />
                            </div>

                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Year <span
                                        class="text-meta-1">*</span> </label>
                                <input id="year" name="year" type="number" placeholder="Enter manufacturing year"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter" />
                            </div>

                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> License Plate <span
                                        class="text-meta-1">*</span> </label>
