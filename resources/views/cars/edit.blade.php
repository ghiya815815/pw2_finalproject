                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default">
                    ...
                    <form enctype="multipart/form-data" action="/cars/{{ $car->id }}" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Photo <span class="text-meta-1">*</span> </label>
                                <input
                                    id="photo"
                                    name="photo"
                                    value="{{$car->photo}}"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> cost_per_day <span class="text-meta-1">*</span> </label>
                                <input
                                    id="cost_per_day"
                                    name="cost_per_day"
